...
import {
  ...
  deleteBlock,
  deleteBlockSetCursorPreviousBlock,
  gotoNextBlock,
  gotoNextParagraph,
  gotoPreviousBlock,
...
const cursorPreviousBlock = markModeMoveCommand(
  gotoPreviousBlock,
  selectPreviousBlock,
);
const cursorNextBlock = markModeMoveCommand(gotoNextBlock, selectNextBlock);
const cursorPreviousParagraph = markModeMoveCommand(
  gotoPreviousParagraph,
  selectPreviousParagraph,
);
const cursorNextParagraph = markModeMoveCommand(
  gotoNextParagraph,
  selectNextParagraph,
);
...
const HEYNOTE_COMMANDS = {
  addNewBlockAfterCurrent: cmd(
    addNewBlockAfterCurrent,
    "Block",
    "Add new block after current block",
  ),
  addNewBlockBeforeCurrent: cmd(
    addNewBlockBeforeCurrent,
    "Block",
    "Add new block before current block",
  ),
  addNewBlockAfterLast: cmd(
    addNewBlockAfterLast,
    "Block",
    "Add new block after last block",
  ),
  addNewBlockBeforeFirst: cmd(
    addNewBlockBeforeFirst,
    "Block",
    "Add new block before first block",
  ),
  insertNewBlockAtCursor: cmd(
    insertNewBlockAtCursor,
    "Block",
    "Insert new block at cursor",
  ),
  deleteBlock: cmd(deleteBlock, "Block", "Delete block"),
  deleteBlockSetCursorPreviousBlock: cmd(
    deleteBlockSetCursorPreviousBlock,
    "Block",
    "Delete block and set cursor to previous block",
  ),
  cursorPreviousBlock: cmd(
    cursorPreviousBlock,
    "Cursor",
    "Move cursor to previous block",
  ),
  cursorNextBlock: cmd(cursorNextBlock, "Cursor", "Move cursor to next block"),
  cursorPreviousParagraph: cmd(
    cursorPreviousParagraph,
    "Cursor",
    "Move cursor to previous paragraph",
  ),
  cursorNextParagraph: cmd(
    cursorNextParagraph,
    "Cursor",
    "Move cursor to next paragraph",
  ),
  toggleSelectionMarkMode: cmd(
    toggleSelectionMarkMode,
    "Cursor",
    "Toggle selection mark mode",
  ),
  selectionMarkModeCancel: cmd(
    selectionMarkModeCancel,
    "Cursor",
    "Cancel selection mark mode",
  ),
  openLanguageSelector: cmd(
  ...
  formatBlockContent: cmdLessContext(
    formatBlockContent,
    "Block",
    "Format block content",
  ),
  moveCurrentBlockUp: cmdLessContext(
    moveCurrentBlockUp,
    "Block",
    "Move current block up",
  ),
  moveCurrentBlockDown: cmdLessContext(
    moveCurrentBlockDown,
    "Block",
  ...
  selectPreviousParagraph: cmdLessContext(
    selectPreviousParagraph,
    "Selection",
    "Select to previous paragraph",
  ),
  selectNextParagraph: cmdLessContext(
    selectNextParagraph,
    "Selection",
    "Select to next paragraph",
  ),
  selectPreviousBlock: cmdLessContext(
    selectPreviousBlock,
    "Selection",
    "Select to previous block",
  ),
  selectNextBlock: cmdLessContext(
    selectNextBlock,
    "Selection",
    "Select to next block",
  ),
  nothing: cmdLessContext(nothing, "Misc", "Do nothing"),
  insertDateAndTime: cmdLessContext(
    insertDateAndTime,
    "Misc",
  ...
  selectNextOccurrence: cmdLessContext(
  ...
  deleteCharForward: cmdLessContext(
    deleteCharForward,
    "Edit",
    "Delete character forward",
  ),
  deleteGroupBackward: cmdLessContext(
    deleteGroupBackward,
    "Edit",
    "Delete group backward",
  ),
  deleteGroupForward: cmdLessContext(
    deleteGroupForward,
    "Edit",
    "Delete group forward",
  ),
  deleteLineBoundaryBackward: cmdLessContext(
    deleteLineBoundaryBackward,
    "Edit",
    "Delete from start of wrapped line",
  ),
  deleteLineBoundaryForward: cmdLessContext(
    deleteLineBoundaryForward,
    "Edit",
    "Delete to end of wrapped line",
  ),
  deleteToLineEnd: cmdLessContext(
    deleteToLineEnd,
    "Edit",
    "Delete to end of line",
  ),
  deleteToLineStart: cmdLessContext(
    deleteToLineStart,
    "Edit",
    "Delete from start of line",
  ),
  simplifySelection: cmdLessContext(
    simplifySelection,
    "Cursor",
    "Simplify selection",
  ),
  splitLine: cmdLessContext(splitLine, "Edit", "Split line"),
  transposeChars: cmdLessContext(
    transposeChars,
    "Edit",
    "Transpose characters",
  ),
  insertNewlineAndIndent: cmdLessContext(
    insertNewlineAndIndent,
    "Edit",
    "Insert newline and indent",
  ),
  insertNewlineContinueMarkup: cmdLessContext(
    insertNewlineContinueMarkup,
    "Markdown",
    "Insert newline and continue todo lists/block quotes",
  ),
  toggleComment: cmdLessContext(toggleComment, "Edit", "Toggle comment"),
  toggleBlockComment: cmdLessContext(
    toggleBlockComment,
    "Edit",
    "Toggle block comment",
  ),
  toggleLineComment: cmdLessContext(
    toggleLineComment,
    "Edit",
    "Toggle line comment",
  ),
...
for (let commandSuffix of [
  ...
  "SubwordBackward",
  "SubwordForward",
  "LineBoundaryBackward",
  "LineBoundaryForward",
  "DocStart",
  "DocEnd",
]) {
  HEYNOTE_COMMANDS[`cursor${commandSuffix}`] = {
    run: markModeMoveCommand(
      codeMirrorCommands[`cursor${commandSuffix}`],
      codeMirrorCommands[`select${commandSuffix}`],
    ),
