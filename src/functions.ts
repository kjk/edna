...
export function parseBoopFunction(s: string): BoopFunction {
...
export function findFunctionByName(funcs: BoopFunction[], name: string): BoopFunction {
  for (let f of funcs) {
    if (f.name === name) {
      return f;
    }
