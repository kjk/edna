...
export function addNoteToHistory(name: string): void {
...
export function renameNoteInHistory(oldName: string, newName: string): void {
...
export function removeNoteFromHistory(name: string): void {
